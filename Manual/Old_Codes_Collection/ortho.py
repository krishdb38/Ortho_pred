...
def WriteQuery(query, parallel_num):
    ...
    try:
        with open("./query/query_"+str(parallel_num), "w") as write_query: # Write query Files inside query Folder
...
def RunBlast(subject, parallel_num):
    ...
    cmd = [Blastp, "-query", "./query/query_"+str(parallel_num), "-subject", subject,
           ...
           # files written by WriteQuet Function inside query Sequence is called
