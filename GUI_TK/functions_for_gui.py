...
# ! Assigning the Variable the variable
# MODE = ["1","3"] # No More Necessary
# USER_SELECTED_NUMBER = (0,1)
selected_species = ("AAE","CAC")  # ! XXXX Remove
...
Log_file_name = "./logs/"+CLUSTER_OUT + "_S"+ str(threshold_score) + "_" + str(inflation_factor) + log_time+"_log.txt"
...
with open(Log_file_name, 'w') as log:
    ...
    for i in MODE:
        log.write(" " + i)
    log.write("\ngenomes : ")
    log.write(subject_file + " ")
    log.write(query_file)
